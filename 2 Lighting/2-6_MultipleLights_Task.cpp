...
void MultipleLights_Task_Desert(GLFWwindow* window) {
	...
	//Shader
	Shader objectShader("Shader2-6.vertex", "Shader2-6.fragment_Task");
	...
	lightShader.use();
	lightShader.setVec3("lampColor", light);
	//定义物体材质和所有光照
	//物体材质
	objectShader.use();
	...
	objectShader.setVec3("pointLight[0].color", pointLightColors[0]);
	objectShader.setVec3("pointLight[1].color", pointLightColors[1]);
	objectShader.setVec3("pointLight[2].color", pointLightColors[2]);
	objectShader.setVec3("pointLight[3].color", pointLightColors[3]);
	...
	objectShader.setVec3("directLight.color", light);
	...
	//Spot light
	light = glm::vec3(1.0f, 1.0f, 1.0f);
	objectShader.setVec3("spotLight.color", light);
	objectShader.setVec3("spotLight.ambient", glm::vec3(0.0f, 0.0f, 0.0f));
	objectShader.setVec3("spotLight.diffuse", glm::vec3(0.8f, 0.8f, 0.0f));
	objectShader.setVec3("spotLight.specular", glm::vec3(0.8f, 0.8f, 0.0f));
...
void MultipleLights_Task_Factory(GLFWwindow* window) {
	...
	objectShader.setVec3("spotLight.specular", diffuse);
	objectShader.setFloat1f("spotLight.constant", 1.0f);
	objectShader.setFloat1f("spotLight.linear", 0.09f);
	objectShader.setFloat1f("spotLight.quadratic", 0.032f);
	objectShader.setFloat1f("spotLight.innerCutOff", glm::cos(glm::radians(12.5f)));
